...
for (r,m) in secretz:
  if count(num,m,"%d %% %d"%(num,m)) != r:
    print
    print("WRONG")#"%d %% %d != %d... WRONG"%(num,m,r)
    sys.exit(0)
  else:
    print
    print("GOOD")#("%d %% %d == %d... GOOD"%(num,m,r))
    time.sleep(2)
    print ('\033[2A')
    print (" "*90)
...
if powmod(num,num2,200009*160009,"%d ^ %d %% %d"%(num,num2,200009*160009)) != 1:
  print
  print ("WRONG")#"%d ^ %d %% %d != 1... WRONG"%(num,num2,200009*160009)
  sys.exit(0)
else:
  print ("CONGRATS")#"Congratulations! The flag is: %s_%s"%(sys.argv[1],str(num2))
